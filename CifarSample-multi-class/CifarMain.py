...
# this is for multi-classificatoin
# mean square loss
# tensorflow API: e^x / sum(e^x)
# e.g. [[0.0,1,0.02,...,0.9,0.03],[],......]
# p_y = tf.nn.softmax(y_)
# # transform label y to one-hot code [0,0,...1,0,0,...]
